    ...
    <div>
            ...
            <div class="flex mb-12">
                ...
                <div class="flex flex-col py-1 px-4">
                    ...
                    <div class="grid grid-cols-2 gap-2 mb-4">
                        ...
                        <p>
                            <fa
                                icon="chevron-right"
                                class="mr-1 text-green-500"
                            /><span class="font-bold">City:</span> New York, USA
                        </p>
                        <p>
                            <fa
                                icon="chevron-right"
                    ...
                    <p>
                        ...
                        elit. Non ex maxime saepe asperiores rem eveniet natus,
                        eos numquam eum tenetur qui pariatur error hic suscipit
                        facere porro obcaecati architecto officia corrupti iste.
                        A beatae, ratione corporis eos est laudantium iste
                        aliquid veniam delectus maxime earum consequatur
                        excepturi dolor sint soluta inventore nihil iure
                        temporibus voluptatem aut possimus eius dolorum mollitia
                        quae! Dolor vel hic veritatis tempora inventore commodi
                        totam iure perferendis consectetur laboriosam quis,
                        earum maxime alias praesentium excepturi cum facere,
                        voluptas quam distinctio nesciunt fugit similique?
                        Assumenda corporis veniam eligendi aut labore sit, quam
                        nesciunt nihil, praesentium, inventore eum.
                    </p>
                </div>
            </div>
        ...
        <div class="section">
            ...
            <div class="icon-box grid grid-cols-4 gap-4">
                ...
                <div>
                    <span><fa class="text-red-600" icon="quidditch" /></span>
                    <h3>Dolor Sitema</h3>
                </div>
                <div>
                    <span><fa class="text-amber-600" icon="running" /></span>
                    <h3>Sed perspiciatis</h3>
                </div>
                <div>
                    <span><fa class="text-lime-600" icon="golf-ball" /></span>
                    <h3>Magni Dolores</h3>
                </div>
                <div>
                    <span><fa class="text-blue-600" icon="dumbbell" /></span>
                    <h3>Nemo Enim</h3>
                </div>
                <div>
                    <span><fa class="text-violet-600" icon="swimmer" /></span>
